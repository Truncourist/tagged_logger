...
require 'tagged_logger/version'

Gem::Specification.new do |spec|
  spec.name          = 'tagged_logger'
  spec.version       = TaggedLogger::VERSION
  spec.authors       = ['Truncourist']
  spec.email         = ['mahmoud.saied@blink22.com']

  spec.summary       = 'Tagged Logger'
  spec.description   = 'A simple Logger, that logs objects error tagged
                        with their IDs'
  spec.homepage      = 'https://github.com/blink22/tagged_logger'
  spec.license       = 'MIT'
